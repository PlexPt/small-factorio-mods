...
--log("=======================boiler==============================")
--log(serpent.block(boiler.fluid_box.pipe_connections))
--log(serpent.block(boiler.output_fluid_box.pipe_connections))
----fixPipeConnections(boiler)
--log("=======================boiler==============================")
