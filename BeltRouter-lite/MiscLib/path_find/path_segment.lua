...
--- @return PathSegment
function PathSegment:fromLuaEntity(entity, halfUndergroundPipeAsInput)
...
--- @return PathSegment[]
function PathSegment:possibleNextPathSegments(allowUnderground)
...
--- @return PathSegment[]
function PathSegment:possiblePrevPathSegments(allowUnderground, canPlaceEntityFunc)
    local attribute = EntityRoutingAttribute.from(self.name)
    local undergroundPrototype = attribute.undergroundEntityPrototype
    local onGroundPrototype = attribute.groundEntityPrototype
    --- @type PathSegment[]|ArrayList
...
function PathSegment:__eq(other)
...
--- @param other PathSegment
--- @return boolean
function PathSegment:canConnect(other)
    local attribute = EntityRoutingAttribute.from(self.name)
    local detectPositions = attribute:getAllPointPositions(self.position, self.direction)
    for _, testUnit in ipairs(other:possiblePrevPathSegments()) do
