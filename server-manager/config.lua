...
-- This stuff is shown in the welcome GUI and Info panel. Make sure it's valid.
WELCOME_MSG_TITLE = "欢迎来到丰富资源的巨无霸圆岛。"
WELCOME_MSG = "[CN]" -- Printed to player on join as well.
SERVER_MSG = "\n"..
        "可以自立也可以一起发展，如果想玩共享资源，扔右边的黄箱里面可以共享给所有人。"

SCENARIO_INFO_MSG = "请阅读以下内容:\n"..
        "初始资金建议购买装备插件,用来清理虫巢赚取更多金币\n"..
        "定期清理无用区块,下线时蜘蛛尽量放到基地里\n"..
        "如果你在前15内分钟离开，你的基地和角色将被删除!"

CONTACT_MSG = "一起玩，需要共享请说声（前提大家有才能共享）。收取在右边的蓝色箱子里面选择数量获取。"
DISCORD_INV = "qq"
...
PLAYER_SPAWN_START_ITEMS = {
    ...
    ["coin"] = 5000, -- Don't give coins unless you have shared chests enabled.
}
